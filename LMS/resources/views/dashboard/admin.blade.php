...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <main class="flex-1">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div class="space-y-6 text-center lg:text-left">
                            ...
                            <p class="text-lg sm:text-xl text-red-50 max-w-2xl">
                                Kelola users, monitor kelas, dan pantau seluruh aktivitas sistem dengan kontrol penuh
                                dan real-time analytics.
                            </p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-md border border-gray-100 hover:shadow-xl transition">
                        <div class="flex items-center justify-between mb-4">
                            <div
                                class="w-12 h-12 rounded-xl bg-gradient-to-br from-red-600 to-rose-600 flex items-center justify-center">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-md border border-gray-100 hover:shadow-xl transition">
                        <div class="flex items-center justify-between mb-4">
                            <div
                                class="w-12 h-12 rounded-xl bg-gradient-to-br from-rose-600 to-pink-600 flex items-center justify-center">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-md border border-gray-100 hover:shadow-xl transition">
                        <div class="flex items-center justify-between mb-4">
                            <div
                                class="w-12 h-12 rounded-xl bg-gradient-to-br from-pink-600 to-red-600 flex items-center justify-center">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-md border border-gray-100 hover:shadow-xl transition">
                        <div class="flex items-center justify-between mb-4">
                            <div
                                class="w-12 h-12 rounded-xl bg-gradient-to-br from-red-600 via-rose-600 to-pink-600 flex items-center justify-center">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mb-12">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button onclick="openAddUserModal()"
                        class="px-4 py-2 bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-xl font-semibold hover:from-red-700 hover:to-rose-700 transition shadow-md flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 4v16m8-8H4" />
                        </svg>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <button onclick="openManageUsersModal()"
                        class="group p-6 bg-white rounded-2xl border-2 border-gray-200 hover:border-red-500 hover:shadow-xl transition-all duration-300">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-red-600 via-rose-600 to-pink-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg">
                    ...
                    <button onclick="openManageClassesModal()"
                        class="group p-6 bg-white rounded-2xl border-2 border-gray-200 hover:border-rose-500 hover:shadow-xl transition-all duration-300">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-red-600 via-rose-600 to-pink-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                    ...
                    <button onclick="openMonitoringModal()"
                        class="group p-6 bg-white rounded-2xl border-2 border-gray-200 hover:border-pink-500 hover:shadow-xl transition-all duration-300">
                        <div
                            class="w-14 h-14 rounded-xl bg-gradient-to-br from-red-600 via-rose-600 to-pink-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            @forelse($progressBySubject as $index => $item)
                                <div>
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-3">
                                        <div class="bg-gradient-to-r from-red-600 to-rose-600 h-3 rounded-full"
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
                        ...
                        <div class="space-y-4">
                            @forelse($topClasses as $index => $class)
                                ...
                                @endphp
                                <div
                                    class="flex items-center justify-between p-3 bg-gradient-to-r from-red-50 to-rose-50 rounded-lg border border-red-100">
                                    <div>
                                        <h4 class="font-semibold text-gray-900">{{ $class->nama_kelas }}</h4>
                                        <p class="text-xs text-gray-600">{{ $class->enrollments_count }} siswa aktif
                                        </p>
                                    </div>
                                    <span
                                        class="px-3 py-1 bg-gradient-to-r from-red-100 to-rose-100 text-red-700 text-xs font-bold rounded-full inline-flex items-center gap-1">
                                        @if ($badgeIcon === 'fire')
        ...
        <div id="addUserModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div
                ...
                <div class="px-6 pt-8 text-center">
                    <div
                        class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-red-600 via-rose-600 to-pink-600 shadow-lg">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}" class="px-6 pt-6 pb-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" placeholder="Contoh: Ahmad Fadli"
                            class="w-full rounded-xl border-2 border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition"
                            required>
                    </div>
                    <div>
                    ...
                    <div class="flex flex-col-reverse sm:flex-row gap-3 pt-2">
                        ...
                        <button type="submit"
                            class="flex-1 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 px-4 py-3 font-semibold text-white hover:from-red-700 hover:to-rose-700 transition shadow-md">
                            Tambah User
                        </button>
                    </div>
                </form>
        ...
        <div id="manageUsersModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div
                class="modal-desktop modal-mobile w-full sm:max-w-3xl bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="mb-4">
                        <div class="relative">
                            ...
                            <input type="text" id="searchUser" placeholder="Cari user..."
                                class="w-full rounded-xl border-2 border-gray-300 pl-12 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition"
                                onkeyup="filterUsers()">
                        </div>
                    </div>
                    <div class="space-y-3" id="userList">
                        @forelse($users as $user)
                            <div class="p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition user-item"
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-10 h-10 rounded-full bg-gradient-to-br from-red-600 to-rose-600 flex items-center justify-center text-white font-semibold">
                                    ...
                                    <div class="flex gap-2">
                                        @if ($user->role !== 'admin')
                                            <button
                                                onclick="viewUser({{ $user->id_user }}, '{{ $user->nama }}', '{{ $user->email }}', '{{ $user->role }}')"
                                            ...
                                            <button
                                                onclick="editUser({{ $user->id_user }}, '{{ $user->nama }}', '{{ $user->email }}', '{{ $user->role }}')"
                                            ...
                                            <form method="POST"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="p-2 text-pink-600 hover:bg-pink-50 rounded-lg transition"
                                                    title="Hapus">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        @else
                                            <span
                                                class="px-3 py-1 bg-purple-100 text-purple-700 text-xs font-bold rounded-full">Protected</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
        ...
        <div id="manageClassesModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div
                class="modal-desktop modal-mobile w-full sm:max-w-3xl bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
                <button onclick="closeManageClassesModal()"
                    class="absolute right-4 top-4 z-10 p-1 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                ...
                <div class="px-6 py-4">
                    <div class="space-y-4">
                        @php
                            $allClasses = \App\Models\Classes::with(['creator', 'enrollments', 'activeToken'])
                            ...
                            <div class="p-4 bg-red-50 rounded-xl border border-red-200">
                                <div class="flex items-center justify-between mb-3">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Token: <span
                                                class="font-mono font-bold text-red-600">{{ $class->activeToken->token_code ?? '-' }}</span>
                                        </p>
                                    </div>
                                    <span
                                        class="px-3 py-1 bg-red-100 text-red-700 text-xs font-bold rounded-full">{{ $class->enrollments_count }}
                                        siswa</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <p class="text-sm text-gray-600">Guru: {{ $class->creator->nama ?? 'Unknown' }}
                                    </p>
                                    <div class="flex gap-2">
                                        <button
                                            onclick="viewClassDetail({{ $class->id_class }}, '{{ $class->nama_kelas }}', '{{ $class->activeToken->token_code ?? '-' }}', '{{ $class->creator->nama ?? 'Unknown' }}', {{ $class->enrollments_count }})"
                                            class="px-3 py-1.5 text-sm text-red-600 hover:bg-red-100 rounded-lg transition font-medium">Detail</button>
                                        <form method="POST"
                                            action="{{ route('admin.classes.delete', $class->id_class) }}"
                                            onsubmit="return confirm('Yakin ingin menghapus kelas ini?')"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                class="px-3 py-1.5 text-sm text-pink-600 hover:bg-pink-100 rounded-lg transition font-medium">Hapus</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
        ...
        <div id="monitoringModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div
                class="modal-desktop modal-mobile w-full sm:max-w-3xl bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
                <button onclick="closeMonitoringModal()"
                    class="absolute right-4 top-4 z-10 p-1 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                ...
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            @forelse($progressBySubject as $index => $item)
                                ...
                                @endphp
                                <div
                                    class="p-3 bg-gradient-to-r from-red-50 to-rose-50 rounded-lg border border-red-100">
                                    <div class="flex justify-between mb-2">
                                        <span class="text-sm font-medium">{{ $item['subject'] }}</span>
                                        <span class="text-sm font-bold text-red-600">{{ $item['progress'] }}%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-gradient-to-r from-red-600 to-rose-600 h-2 rounded-full"
                                            style="width: {{ $item['progress'] }}%"></div>
                                    </div>
                                </div>
                            @empty
                    ...
                    <div
                        class="bg-gradient-to-br from-red-50 via-rose-50 to-pink-50 rounded-xl p-4 border border-red-200">
                        <div class="flex items-start gap-3">
                            <div
                                class="w-10 h-10 rounded-full bg-gradient-to-br from-red-600 via-rose-600 to-pink-600 flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="flex-1">
                                <h4 class="font-bold text-gray-900 mb-2 flex items-center gap-2">
                                    ...
                                    <span
                                        class="px-2 py-0.5 bg-red-100 text-red-700 text-xs font-bold rounded-full">Beta</span>
                                </h4>
                                @php
                                ...
                                <div class="space-y-2 text-sm text-gray-700">
                                    <p class="flex items-start gap-2">
                                        ...
                                        <span><strong>Engagement Rate:</strong> {{ $engagementRate }}% user aktif hari
                                            ini -
                                            {{ $engagementRate >= 50 ? 'Sangat baik!' : 'Perlu ditingkatkan' }}</span>
                                    </p>
                                    <p class="flex items-start gap-2">
                                        <svg class="w-4 h-4 text-red-600 mt-0.5 flex-shrink-0" fill="currentColor"
                                            viewBox="0 0 20 20">
                                        ...
                                        <span><strong>Completion Rate:</strong> {{ $completionRate }}% tugas
                                            diselesaikan -
                                            {{ $completionRate >= 70 ? 'Target tercapai!' : 'Butuh perhatian' }}</span>
                                    </p>
                                    <p class="flex items-start gap-2">
                                        <svg class="w-4 h-4 text-red-600 mt-0.5 flex-shrink-0" fill="currentColor"
                                            viewBox="0 0 20 20">
                                        ...
                                        <span><strong>Rekomendasi:</strong>
                                            {{ $engagementRate < 50 ? 'Tingkatkan notifikasi dan reminder untuk meningkatkan engagement' : 'Pertahankan momentum dengan konten berkualitas' }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div id="viewClassModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div
                ...
                <div class="px-6 pt-6 pb-6 space-y-4">
                    ...
                    <button onclick="closeViewClassModal()"
                        class="w-full rounded-xl border-2 border-gray-300 px-4 py-3 text-gray-700 hover:bg-gray-50 transition font-medium mt-4">
                        Tutup
                    </button>
                </div>
            </div>
