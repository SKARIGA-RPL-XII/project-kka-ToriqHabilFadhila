                ...
                <div class="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                            ...
                            <span class="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-bold rounded-full">🔥 Hot</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                            ...
                            <span class="px-3 py-1 bg-purple-100 text-purple-700 text-xs font-bold rounded-full">⭐ Top</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                            ...
                            <span class="px-3 py-1 bg-green-100 text-green-700 text-xs font-bold rounded-full">📈 Rising</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="manageUsersModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
        <div class="modal-desktop modal-mobile w-full sm:max-w-3xl bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
            ...
            <div class="px-6 py-4">
                <!-- Search Bar -->
                <div class="mb-4">
                    <input type="text" placeholder="🔍 Cari user..." class="w-full rounded-xl border-2 border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                </div>
