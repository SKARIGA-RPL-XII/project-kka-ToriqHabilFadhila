...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <main class="flex-1">
        <section
            class="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="space-y-6 text-center lg:text-left">
                            ...
                            <p class="text-lg sm:text-xl text-red-50 max-w-2xl">
                                Ikuti kelas, pelajari materi, kerjakan tugas, dan pantau progres belajarmu dengan lebih
                                terarah dan modern.
                            </p>
        ...
        <section class="w-full px-4 sm:px-6 md:px-16 py-12">
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <!-- Lihat Tugas Card -->
                    <a href="#tugas-terbaru"
                        onclick="event.preventDefault(); document.getElementById('tugas-terbaru').scrollIntoView({behavior: 'smooth'});"
                        class="group relative p-6 bg-white rounded-2xl border-2 border-gray-100 hover:border-indigo-500 hover:shadow-2xl transition-all duration-300 overflow-hidden block">
                        <div
                        ...
                        <div class="relative">
                            <div
                                class="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-indigo-500/30">
                            ...
                            <div
                                class="inline-flex items-center px-3 py-1 rounded-full bg-indigo-50 text-indigo-600 text-xs font-semibold">
                    ...
                    <!-- Lihat Materi Card -->
                    <a href="{{ route('siswa.materials') }}"
                        class="group relative p-6 bg-white rounded-2xl border-2 border-gray-100 hover:border-purple-500 hover:shadow-2xl transition-all duration-300 overflow-hidden block">
                        <div
                        ...
                        <div class="relative">
                            <div
                                class="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-purple-500/30">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div
                                class="inline-flex items-center px-3 py-1 rounded-full bg-purple-50 text-purple-600 text-xs font-semibold">
                    ...
                    <a href="{{ route('siswa.recommendations') }}"
                        class="group relative p-6 bg-white rounded-2xl border-2 border-gray-100 hover:border-pink-500 hover:shadow-2xl transition-all duration-300 overflow-hidden block">
                        ...
                        <div class="relative">
                            <div
                                class="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-pink-500/30">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <h3
                                class="text-lg font-bold text-gray-900 mb-2 group-hover:text-pink-600 transition-colors">
                                Rekomendasi Materi & Progres Pembelajaran</h3>
                            <p class="text-sm text-gray-500 mb-3">AI merekomendasikan materi berdasarkan perkembangan
                                belajarmu</p>
                            <!-- Progress Bar -->
                        ...
                        <div x-show="showAll || {{ $index }} < 3" x-cloak
                            ...
                            <div class="p-6">
                                <div class="flex items-center gap-2 mb-3">
                                    <span
                                        class="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-bold rounded-full">{{ $kelas->nama_kelas }}</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                    ...
                                    <a href="{{ route('siswa.classes.show', $kelas->id_class) }}"
                    ...
                    @empty
                        <div class="col-span-full text-center py-12">
                            ...
                            <button onclick="openJoinClassModal()"
                                class="inline-flex items-center gap-2 px-4 py-2.5 bg-indigo-600 text-white text-sm rounded-xl hover:bg-indigo-700 transition font-semibold shadow-md">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                <div class="flex-1">
                                    <div class="flex flex-wrap items-center gap-2 mb-3">
                                        <span
                                            class="px-3 py-1.5 {{ $badgeClass }} text-xs font-bold rounded-full inline-flex items-center gap-1">
                                            {!! $badgeIcon !!}
                                            {{ $badgeText }}
                                        </span>
                                        <span
                                            class="px-3 py-1.5 {{ $isCompleted ? 'bg-green-100 text-green-700' : $subjectColor }} text-xs font-bold rounded-full">{{ $assignment->class->nama_kelas }}</span>
                                    </div>
                                    <h3 class="text-lg font-bold text-gray-900 mb-2">{{ $assignment->judul }}</h3>
                                    <p class="text-sm text-gray-600 mb-4">
                                        {{ Str::limit($assignment->deskripsi, 100) }}</p>
                                    <div class="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                                        @if ($isCompleted && $assignment->submission)
                                            <div class="flex items-center gap-1.5">
                                                ...
                                                <span class="font-semibold text-green-600">Nilai:
                                ...
                                @if ($isCompleted)
                                    <a href="{{ route('siswa.submissions.show', $assignment->submission->id_submission) }}"
                                        class="px-4 py-2 bg-gray-100 text-gray-700 text-sm rounded-xl hover:bg-gray-200 transition font-semibold inline-block text-center">
                                        Lihat Detail
                                    </a>
                                @else
                                    <a href="{{ route('siswa.assignments.show', $assignment->id_assignment) }}"
                                        class="px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-sm rounded-xl hover:from-indigo-700 hover:to-purple-700 transition font-semibold shadow-md inline-block text-center">
                                        Kerjakan
                                    </a>
                                @endif
                            </div>
        ...
        <div id="joinClassModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div
                ...
                <div class="px-6 pt-8 text-center">
                    <div
                        class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 shadow-lg">
                ...
                <form action="{{ route('siswa.join') }}" method="POST" class="px-6 pt-6">
                    ...
                    <input type="text" name="token" id="classToken" placeholder="Masukkan token kelas"
                        class="w-full rounded-xl border-2 border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition [text-transform:uppercase] placeholder:normal-case"
                        oninput="this.value = this.value.toUpperCase().replace(/\s/g, '')" autocomplete="off"
                    ...
                    <div class="flex flex-col-reverse sm:flex-row gap-3 pt-6 pb-6">
                        ...
                        <button type="submit"
                            class="flex-1 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 px-4 py-2.5 text-sm font-semibold text-white hover:opacity-90 transition shadow-md shadow-indigo-200">
                            Join Kelas
                        </button>
                    </div>
                </form>
