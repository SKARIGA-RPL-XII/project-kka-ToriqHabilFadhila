...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <main class="flex-1">
        <section
            class="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 text-white relative overflow-hidden">
            ...
            <div class="absolute inset-0 opacity-10">
                ...
                <div
                    class="absolute top-0 right-0 w-96 h-96 bg-yellow-200 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000">
                </div>
                <div
                    class="absolute bottom-0 left-20 w-96 h-96 bg-orange-200 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000">
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="space-y-6 text-center lg:text-left">
                            ...
                            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
                                Selamat Datang,<br>
                                <span
                                    class="bg-gradient-to-r from-yellow-300 via-yellow-200 to-yellow-300 bg-clip-text text-transparent animate-gradient">
                                    {{ Auth::user()?->nama ?? 'Admin' }}!
                                </span>
                            </h1>

                            <p class="text-lg sm:text-xl text-red-50 max-w-2xl">
                                Kelola kelas, upload materi pembelajaran, buat tugas & quiz, dan pantau progress siswa
                                dengan mudah.
                            </p>
                            ...
                            <div class="flex flex-wrap gap-4 justify-center lg:justify-start pt-4">
                                <div class="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-xl">
                                    <svg class="w-6 h-6 text-gray-800 dark:text-green-300" aria-hidden="true"
                        ...
                        <div class="hidden lg:flex justify-center items-center">
                            <div class="relative">
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full blur-3xl opacity-20 animate-pulse">
                                </div>
                                <img src="/SVG/Education.svg" alt="Admin Dashboard"
                                    class="relative w-full max-w-lg h-auto drop-shadow-2xl transform hover:scale-105 transition-transform duration-500">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="w-full px-4 sm:px-6 md:px-16 py-12">
            ...
            <div class="mb-12">
                ...
                <div class="lg:col-span-3 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6">
                    <button onclick="openAIGuruModal()"
                        class="group p-4 sm:p-6 bg-white rounded-2xl border-2 border-gray-200 hover:border-blue-500 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center gap-3 sm:gap-4">
                        <div
                            class="w-12 sm:w-14 h-12 sm:h-14 rounded-xl bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-purple-500/25 group-hover:shadow-purple-500/40">
                            <svg class="w-7 sm:w-8 h-7 sm:h-8 text-white" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <button onclick="openUploadMateriModal()"
                        class="group p-4 sm:p-6 bg-white rounded-2xl border-2 border-gray-200 hover:border-blue-500 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center gap-3 sm:gap-4">
                        <div
                            class="w-12 sm:w-14 h-12 sm:h-14 rounded-xl bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-purple-500/25 group-hover:shadow-purple-500/40">
                            <svg class="w-7 sm:w-8 h-7 sm:h-8 text-white" fill="none" stroke="currentColor"
                    ...
                    <button onclick="openJawabanSiswaModal()"
                        class="group p-4 sm:p-6 bg-white rounded-2xl border-2 border-gray-200 hover:border-blue-500 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center gap-3 sm:gap-4">
                        <div
                            class="w-12 sm:w-14 h-12 sm:h-14 rounded-xl bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-purple-500/25 group-hover:shadow-purple-500/40">
                            <svg class="w-7 sm:w-8 h-7 sm:h-8 text-white" fill="none" stroke="currentColor"
            ...
            <div x-data="{ showAll: false }" class="mb-12">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button @click="showAll = !showAll"
                        class="px-4 py-2 rounded-xl text-white font-semibold flex items-center gap-2 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 hover:from-slate-800 hover:via-blue-800 hover:to-indigo-700 hover:scale-105 transition-all duration-300 shadow-lg shadow-indigo-500/50 hover:shadow-indigo-600/70">
                        <span x-text="showAll ? 'Lihat Sedikit' : 'Lihat Semua'"></span>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path x-show="!showAll" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 5l7 7-7 7" />
                            <path x-show="showAll" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 19l-7-7 7-7" />
                        </svg>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @forelse ($classes as $index => $kelas)
                        <div x-show="showAll || {{ $index }} < 3" x-cloak
                            class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                            <!-- Class Card 1 -->
                            <div
                                class="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                                <div
                                    class="h-36 relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 transition-all duration-300 group-hover:scale-105">
                                    <div class="absolute inset-0 bg-black/10"></div>
                                    <div class="absolute inset-0 bg-white/5"></div>
                                    <!-- Floating decorative icons -->
                                    <svg class="absolute top-3 right-6 w-10 h-10 text-white/25 animate-float"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z" />
                                    </svg>
                                    <svg class="absolute bottom-4 left-4 w-12 h-12 text-white/20 animate-pulse"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
                                    </svg>
                                    <svg class="absolute top-1/2 right-1/3 w-14 h-14 text-white/15 animate-bounce"
                                        style="animation-delay: 0.3s" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                ...
                                <div class="p-6">
                                    <div class="flex items-center gap-2 mb-3">
                                        <span
                                            class="px-3 py-1 bg-purple-100 text-purple-700 text-xs font-bold rounded-full">{{ $kelas->nama_kelas }}</span>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                        ...
                                        <a href="{{ route('guru.classes.show', $kelas->id_class) }}"
            ...
            <div x-data="{ showAllAssignments: false }" class="mb-12">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button @click="showAllAssignments = !showAllAssignments"
                        ...
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path x-show="!showAllAssignments" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                    @forelse($assignments as $index => $assignment)
                        <div x-show="showAllAssignments || {{ $index }} < 3" x-cloak
                            class="p-6 {{ !$loop->last ? 'border-b border-gray-100' : '' }} hover:bg-gray-50 transition">
                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                <div class="flex-1">
                                    <div class="flex flex-wrap items-center gap-2 mb-3">
                                        <span
                                            class="px-3 py-1.5 bg-purple-100 text-purple-700 text-xs font-bold rounded-full">{{ $assignment->class->nama_kelas }}</span>
                                        @if ($assignment->tipe === 'essay')
                                            <span
                                                class="px-3 py-1.5 bg-green-100 text-green-700 text-xs font-bold rounded-full inline-flex items-center gap-1">
                                            @elseif($assignment->tipe === 'pilihan_ganda')
                                                <span
                                                    class="px-3 py-1.5 bg-orange-100 text-orange-700 text-xs font-bold rounded-full inline-flex items-center gap-1">
                                                @else
                                                    <span
                                                        class="px-3 py-1.5 bg-purple-100 text-purple-700 text-xs font-bold rounded-full inline-flex items-center gap-1">
                                        @endif
                                        @if ($assignment->tipe === 'essay')
                                    ...
                                    <p class="text-sm text-gray-600 mb-4">{{ $assignment->deskripsi }} • Deadline:
                                        {{ $assignment->deadline->format('d M Y, H:i') }}</p>
                                    <div class="flex flex-wrap items-center gap-4 text-sm">
                                        @php
                                            $submissionCount = \App\Models\Submission::where(
                                                'id_assignment',
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ route('guru.assignments.submissions', $assignment->id_assignment) }}"
                                        class="px-6 py-2.5 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 text-white rounded-xl hover:from-slate-800 hover:via-blue-800 hover:to-indigo-700 hover:scale-105 transition-all duration-300 font-semibold shadow-lg shadow-indigo-500/50 hover:shadow-indigo-600/70 whitespace-nowrap">
                                        Lihat Jawaban
                                    </a>
                                    <button
                                        onclick="openEditDeadlineModal({{ $assignment->id_assignment }}, '{{ $assignment->deadline->format('Y-m-d\TH:i') }}')"
                                        class="px-6 py-2.5 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 text-white rounded-xl hover:from-slate-800 hover:via-blue-800 hover:to-indigo-700 hover:scale-105 transition-all duration-300 font-semibold shadow-lg shadow-indigo-500/50 hover:shadow-indigo-600/70 whitespace-nowrap">
                                        Edit Deadline
                                    </button>
                                    <button
                                        onclick="openDeleteAssignmentModal({{ $assignment->id_assignment }}, '{{ $assignment->judul }}')"
                                        class="px-6 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 transition font-semibold shadow-md hover:shadow-lg whitespace-nowrap">
                                        Hapus
                                    </button>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                <div class="flex-1">
                                    <div class="flex flex-wrap items-center gap-2 mb-3">
                                        <span
                                            class="px-3 py-1.5 bg-purple-100 text-purple-700 text-xs font-bold rounded-full">{{ $material->class->nama_kelas }}</span>
                                        <span
                                            class="px-3 py-1.5 bg-indigo-100 text-indigo-700 text-xs font-bold rounded-full inline-flex items-center gap-1">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <p class="text-sm text-gray-600 mb-4">{{ Str::limit($material->konten, 100) }} •
                                        Diupload: {{ $material->created_at->format('d M Y, H:i') }}</p>
                                    <div class="flex flex-wrap items-center gap-4 text-sm">
        ...
        <div id="createClassModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div class="flex items-end sm:items-center justify-center min-h-screen w-full">
                <div
                    class="w-full sm:max-w-md bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="px-6 pt-8 text-center">
                        <div
                            class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 shadow-lg">
                    ...
                    <form method="POST" action="{{ route('guru.classes.store') }}"
                        class="px-6 pt-6 pb-6 space-y-4">
                        @csrf
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 mb-2">Nama Kelas</label>
                            <input type="text" name="nama_kelas" placeholder="Contoh: 8A"
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 mb-2">Deskripsi Mata
                                Pelajaran</label>
                            <input type="text" name="deskripsi"
                                placeholder="Contoh: Matematika, IPA, Bahasa Inggris, dsb"
                                class="w-full rounded-xl border-2 border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="max_students" value="50" min="1"
                                class="w-full rounded-xl border-2 border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition"
                                required>
                        </div>
        ...
        <div id="tokenModal" class="fixed inset-0 items-center justify-center bg-black bg-opacity-50 hidden z-50">
            <div class="bg-white rounded-xl w-96 p-6 shadow-lg">
                ...
                <div class="text-center text-2xl font-mono mb-6 p-4 bg-gray-100 rounded-lg" id="tokenValue">TOKEN123
                </div>
        ...
        <div id="uploadMateriModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div class="flex items-end sm:items-center justify-center min-h-screen w-full">
                <div
                    class="w-full sm:max-w-md bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
                    <button onclick="closeUploadMateriModal()"
                        class="absolute right-4 top-4 z-10 p-1 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                    ...
                    <form method="POST" action="{{ route('guru.materials.store') }}" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <select name="id_class"
                                ...
                                @foreach ($classes as $kelas)
                                    <option value="{{ $kelas->id_class }}">{{ $kelas->nama_kelas }} -
                                        {{ $kelas->deskripsi }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div id="dropzone"
                                class="relative flex flex-col items-center justify-center w-full h-40 rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 cursor-pointer hover:bg-gray-100 transition">
        ...
        <div id="createTugasModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div class="flex items-end sm:items-center justify-center min-h-screen w-full">
                <div
                    ...
                    <form method="POST" action="{{ route('guru.assignments.store') }}"
                        class="px-6 pt-6 pb-6 space-y-4">
                        @csrf
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 mb-2">Pilih Kelas</label>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <label class="relative cursor-pointer">
                                    <input type="radio" name="tipe" value="essay" class="peer sr-only"
                                        required>
                                    <div
                                        class="p-4 text-center border-2 border-gray-300 rounded-xl transition-all peer-checked:border-green-500 peer-checked:bg-gradient-to-br peer-checked:from-green-50 peer-checked:to-emerald-50 peer-checked:shadow-md hover:border-green-400">
                                ...
                                <label class="relative cursor-pointer">
                                    ...
                                    <div
                                        class="p-4 text-center border-2 border-gray-300 rounded-xl transition-all peer-checked:border-orange-500 peer-checked:bg-gradient-to-br peer-checked:from-orange-50 peer-checked:to-amber-50 peer-checked:shadow-md hover:border-orange-400">
                                        <div class="flex justify-center mb-2">
                                ...
                                <label class="relative cursor-pointer">
                                    ...
                                    <div
                                        class="p-4 text-center border-2 border-gray-300 rounded-xl transition-all peer-checked:border-purple-500 peer-checked:bg-gradient-to-br peer-checked:from-purple-50 peer-checked:to-pink-50 peer-checked:shadow-md hover:border-purple-400">
                                        <div class="flex justify-center mb-2">
        ...
        <div id="editDeadlineModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div class="flex items-end sm:items-center justify-center min-h-screen w-full">
                <div
                    class="w-full sm:max-w-md bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
                    <button onclick="closeEditDeadlineModal()"
                        class="absolute right-4 top-4 z-10 p-1 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                    ...
                    <form id="editDeadlineForm" method="POST" class="px-6 pt-6 pb-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="deadlineInput" name="deadline"
                                class="w-full rounded-xl border-2 border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition"
                                required>
                        </div>
        ...
        <div id="jawabanSiswaModal" class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div class="flex items-end sm:items-center justify-center min-h-screen w-full">
                <div
                    class="w-full sm:max-w-2xl bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
                            ...
                            <a href="{{ route('guru.assignments.submissions', $assignment->id_assignment) }}"
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">{{ $assignment->class->nama_kelas }} -
        ...
        <div id="deleteAssignmentModal"
            class="fixed inset-0 z-50 hidden bg-black/40 backdrop-blur-sm animate-backdrop">
            <div class="flex items-end sm:items-center justify-center min-h-screen w-full">
                <div
                    class="w-full sm:max-w-md bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
                    <div class="p-6 text-center">
                        <div
                            class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-red-100 animate-warning">
                        ...
                        <p class="text-gray-600 mb-1">Tugas: <span id="deleteAssignmentTitle"
            ...
            <div class="flex items-end sm:items-center justify-center min-h-screen w-full">
                <div
                    ...
                    <div class="px-6 py-6 space-y-4">
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 mb-2">Pilih Kelas</label>
                            <select id="aiClassSelect" onchange="loadStudentsForClass()"
                                class="w-full rounded-xl border-2 border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 mb-2">Pilih Siswa
                                (Opsional)</label>
                        ...
                        <div>
                            ...
                            <textarea id="aiGuruQuestion" rows="4"
                                placeholder="Contoh: Bagaimana performa kelas secara keseluruhan? Atau: Siapa siswa yang paling membutuhkan bantuan?"
                            ...
                            <p class="text-xs text-gray-500 mt-1">Pertanyaan ini opsional. AI akan menganalisis
                                berdasarkan data yang tersedia.</p>
                        </div>
                        ...
                        <div id="aiGuruResultContainer" class="hidden">
                            ...
                            <div id="aiGuruResult"
                                class="w-full rounded-xl border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 to-purple-50 px-4 py-4 text-sm text-gray-700 max-h-[500px] overflow-y-auto custom-scrollbar">
                            </div>
                        </div>
                    ...
                    <div class="px-6 pb-6 border-t border-gray-200 flex flex-col-reverse sm:flex-row gap-3 pt-4">
                        ...
                        <button type="button" onclick="askAIGuruDashboard()"
                            class="flex-1 rounded-xl bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 px-4 py-2.5 text-sm font-semibold text-white hover:from-slate-800 hover:via-blue-800 hover:to-indigo-700 hover:scale-105 transition-all duration-300 shadow-lg shadow-indigo-500/50 hover:shadow-indigo-600/70">
                            Tanya AI
                        </button>
                    </div>
                </div>
    ...
    <script>
        const classStudents = @json(
            $classes->mapWithKeys(function ($kelas) {
                return [
                    $kelas->id_class => $kelas->enrollments->map(function ($enrollment) {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        if (isGeneralQuestion) {
                            result +=
                                '<div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-5 rounded-xl border-2 border-blue-300">';
                            ...
                            result += '</p>';
                            result += '<p class="text-sm text-gray-700 leading-relaxed whitespace-pre-line">' + (
                                customAnswer.answer || customAnswer) + '</p>';
                            result += '</div>';
                        } else {
                            if (studentId) {
                                const studentSelect = document.getElementById('aiStudentSelect');
                                ...
                                result +=
                                    '<div class="bg-gradient-to-r from-indigo-100 to-purple-100 p-4 rounded-xl border-2 border-indigo-300">';
                                ...
                                result += '<p class="text-xl font-bold text-indigo-600">' + (metrics.completion_rate ||
                                    0) + '%</p>';
                                result += '</div>';
                                result += '<div class="bg-white p-3 rounded-xl border-2 border-gray-200 shadow-sm">';
                                result += '<p class="text-xs text-gray-500 mb-1">⏰ On-Time Rate</p>';
                                result += '<p class="text-xl font-bold text-green-600">' + (metrics.on_time_rate || 0) +
                                    '%</p>';
                                result += '</div>';
                                result += '<div class="bg-white p-3 rounded-xl border-2 border-gray-200 shadow-sm">';
                                result += '<p class="text-xs text-gray-500 mb-1">📈 Average Score</p>';
                                result += '<p class="text-xl font-bold text-purple-600">' + (metrics.avg_score || 0) +
                                    '</p>';
                                result += '</div>';
                                result += '<div class="bg-white p-3 rounded-xl border-2 border-gray-200 shadow-sm">';
                                result += '<p class="text-xs text-gray-500 mb-1">📉 Trend</p>';
                                result += '<p class="text-xl font-bold text-blue-600 capitalize">' + (metrics.trend ||
                                    '-') + '</p>';
                                result += '</div>';
                                result += '</div>';
                            }
                        ...
                        document.getElementById('aiGuruResult').innerHTML = '<p class="text-red-600">❌ ' + (data
                            .message || 'Gagal mendapatkan analisis') + '</p>';
                    }
                })
                .catch(error => {
                    document.getElementById('aiGuruLoading').classList.add('hidden');
                    document.getElementById('aiGuruResultContainer').classList.remove('hidden');
                    document.getElementById('aiGuruResult').innerHTML =
