                ...
                <div
                    ...
                    <div class="h-32 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 relative">
                        ...
                        <div class="absolute bottom-4 left-4">
                            <span
                                class="px-3 py-1 bg-white/20 backdrop-blur-sm text-white text-xs font-bold rounded-full">
                        ...
                        <div class="flex gap-2">
                            @if ($material->file_path)
                                <a href="{{ asset('storage/' . $material->file_path) }}" target="_blank"
                                    class="flex-1 px-4 py-2.5 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white rounded-xl hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 transition font-semibold text-center">
                            ...
                            @if ($material->online_link)
                                <a href="{{ $material->online_link }}" target="_blank"
                                    class="flex-1 px-4 py-2.5 bg-gradient-to-r from-blue-600 via-cyan-600 to-teal-600 text-white rounded-xl hover:from-blue-700 hover:via-cyan-700 hover:to-teal-700 transition font-semibold text-center">
                                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            @if (!$material->file_path && !$material->online_link)
                                <button
                                    class="w-full px-4 py-2.5 bg-gray-100 text-gray-500 rounded-xl cursor-not-allowed font-semibold text-center">
                                    Tidak Ada Materi
                                </button>
                            @endif
                        </div>
