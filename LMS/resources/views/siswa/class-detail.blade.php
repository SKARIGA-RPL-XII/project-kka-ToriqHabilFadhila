                ...
                <div class="flex items-start gap-4 mb-6">
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-2 text-sm">
                            ...
                            <span class="text-purple-100">Guru: <span
                                    class="font-semibold">{{ $kelas->creator->nama }}</span></span>
                        </div>
                    </div>
                </div>
        ...
        <div class="mb-8">
            <a href="{{ route('siswa.materials') }}"
                ...
                <div class="relative flex items-center gap-4">
                    <div
                        class="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-indigo-500/30">
        ...
        <div id="tugas-quiz" class="bg-white rounded-3xl shadow-xl overflow-hidden animate-fade-in-up">
            ...
            <div class="divide-y divide-gray-100">
                @forelse($kelas->assignments as $index => $assignment)
                    ...
                    @endphp
                    <a href="{{ $isCompleted ? route('siswa.submissions.show', $submission->id_submission) : route('siswa.assignments.show', $assignment->id_assignment) }}"
                        class="assignment-card block p-6 hover:bg-gradient-to-r hover:from-indigo-50/50 hover:to-transparent transition-all"
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                            <div class="flex-1">
                                <div class="flex items-start gap-3 mb-3">
                                    ...
                                    <div class="flex-1">
                                        <h3
                                            class="font-bold text-lg text-gray-800 mb-1 group-hover:text-indigo-600 transition">
                                            {{ $assignment->judul }}
                                        </h3>
                                ...
                                <div class="flex items-center gap-2 mt-3 text-sm flex-wrap">
                                    ...
                                    @if ($isCompleted)
                                        @if ($submission->status === 'graded')
                                            <span
                                                class="ml-2 px-3 py-1 text-xs font-bold rounded-full bg-green-100 text-green-700 flex items-center gap-1">
                                        ...
                                        @else
                                            <span
                                                class="ml-2 px-3 py-1 text-xs font-bold rounded-full bg-blue-100 text-blue-700 flex items-center gap-1">
                                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd"
                                    ...
                                    @elseif($isLate)
                                        <span
                                            class="ml-2 px-3 py-1 text-xs font-bold rounded-full bg-gray-100 text-gray-600 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                    ...
                                    @else
                                        ...
                                        @endphp
                                        <span
                                            class="ml-2 px-3 py-1 text-xs font-bold rounded-full {{ $deadlineBadgeClass }}">
                            ...
                            <div class="flex-shrink-0">
                                ...
                                @endphp
                                <span
                                    class="inline-flex items-center gap-2 px-4 py-2 text-xs font-bold rounded-xl shadow-sm {{ $statusBadgeClass }}">
                                    {{ $statusText }}
                                </span>
                            </div>
                        </div>
                ...
                @empty
                    <div class="text-center py-16 px-4">
                        ...
                        <p class="text-gray-500 max-w-md mx-auto">
                            Saat ini belum ada tugas atau quiz yang tersedia untuk kelas ini. Pantau terus untuk update
                            terbaru!
                        </p>
                    </div>
                @endforelse
