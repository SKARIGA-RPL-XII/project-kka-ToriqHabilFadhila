...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen" data-role="{{ auth()->user()->role }}">
    ...
    <div class="w-full px-4 sm:px-6 lg:px-16 py-8 sm:py-12">
        ...
        @if ($errors->any())
            <div
                class="max-w-4xl mx-auto mb-6 bg-gradient-to-r from-red-50 to-rose-50 border-l-4 border-red-500 text-red-800 px-4 sm:px-6 py-4 rounded-xl shadow-md">
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                <div class="bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600 px-4 sm:px-6 lg:px-8 py-6 sm:py-8 text-white relative overflow-hidden"
                    style="background: var(--brand-gradient);">
                    <div
                        class="absolute top-0 right-0 w-32 h-32 sm:w-64 sm:h-64 bg-white/10 rounded-full -mr-16 sm:-mr-32 -mt-16 sm:-mt-32">
                    </div>
                ...
                <div class="p-4 sm:p-6 lg:p-8">
                    ...
                    <form method="POST" action="{{ route('profile.password') }}" class="space-y-6" id="passwordForm">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="current_password" id="currentPassword"
                                    class="w-full px-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-xl focus:ring-2 focus:border-transparent transition-all pr-12"
                                ...
                                <button type="button"
                                    ...
                                    style="hover:color: var(--brand-from);" onclick="togglePassword('currentPassword')">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="newPassword"
                                    class="w-full px-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-xl focus:ring-2 focus:border-transparent transition-all pr-12"
                                    style="--tw-ring-color: var(--brand-from);" required minlength="6">
                                <button type="button"
                                    class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 transition-colors"
                                    style="hover:color: var(--brand-from);" onclick="togglePassword('newPassword')">
                        ...
                        <div>
                            <label class="block text-xs sm:text-sm font-bold text-gray-700 mb-2">Konfirmasi Password
                                Baru</label>
                            <div class="relative">
                                ...
                                <button type="button"
                                    class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 transition-colors"
                                    style="hover:color: var(--brand-from);" onclick="togglePassword('confirmPassword')">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 pt-4">
                            <a href="{{ route('dashboard') }}"
                                class="flex-1 px-6 py-2.5 sm:py-3 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all font-semibold text-center text-sm sm:text-base flex items-center justify-center gap-2">
                                <i class="fas fa-times"></i>
                                <span>Batal</span>
                            </a>
                            <button type="submit"
                                class="flex-1 px-6 py-2.5 sm:py-3 text-white rounded-xl transition-all font-semibold shadow-lg text-sm sm:text-base flex items-center justify-center gap-2"
                                style="background: var(--brand-gradient);" onmouseover="this.style.opacity='0.9'"
