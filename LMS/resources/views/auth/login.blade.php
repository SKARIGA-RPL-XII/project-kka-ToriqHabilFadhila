...
<body>
        ...
        <div class="right-panel">
            <div class="form-inner">
                ...
                <div class="form-heading">
                    <h2 class="form-title">Login Sekarang</h2>
                    <p class="form-desc">Silakan masuk ke akun Anda untuk melanjutkan pembelajaran.</p>
                </div>
                <!-- Form -->
                ...
                <div class="divider"><span>atau login dengan</span></div>

                <a href="{{ route('google.auth') }}" class="btn-google" onclick="handleGoogleLogin(this)">
                ...
                <div class="register-row">
                    Belum punya akun?
                    <a href="/register" class="register-link">Registrasi sekarang</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function handleGoogleLogin(el) {
            ...
            el.innerHTML = `
                <svg class="animate-spin" style="width:18px;height:18px;" viewBox="0 0 24 24">
