...
<body>
    ...
    <div class="auth-card">
        <div class="left-panel">
            ...
            <p class="left-sub">Platform pembelajaran berbasis AI yang membantu Anda belajar lebih efektif dan efisien.
            </p>
            ...
            <div class="form-inner">
                ...
                @if ($mode === 'request')
                    <div class="mode-icon-wrap">
                        <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                                <linearGradient id="iconGrad" x1="0%" y1="0%" x2="100%"
                                    y2="100%">
                                    <stop offset="0%" stop-color="#7c3aed" />
                                    <stop offset="100%" stop-color="#db2777" />
                                </linearGradient>
                            </defs>
                            <path stroke="url(#iconGrad)" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="1.8"
                    ...
                    <div class="form-heading">
                        ...
                        <p class="form-desc">Masukkan email Anda dan kami akan mengirimkan link untuk mereset password.
                        </p>
                    </div>
                ...
                @if ($mode === 'reset')
                    <div class="mode-icon-wrap">
                        <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                                <linearGradient id="iconGrad2" x1="0%" y1="0%" x2="100%"
                                    y2="100%">
                                    <stop offset="0%" stop-color="#7c3aed" />
                                    <stop offset="100%" stop-color="#db2777" />
                                </linearGradient>
                            </defs>
                            <path stroke="url(#iconGrad2)" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="1.8"
                    ...
                    <div class="step-indicator" style="margin-bottom:1.5rem;">
                        <div style="display:flex;flex-direction:column;align-items:center;gap:4px;">
                            <div class="step done">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2.5" stroke="currentColor" style="width:13px;height:13px;">
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <button type="button" class="toggle-password"
                                    onclick="togglePassword('password','eyeOpen-password','eyeClosed-password')"
                                    aria-label="Toggle password">
                                    <svg id="eyeOpen-password" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    <svg id="eyeClosed-password" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <div style="display:flex;gap:4px;margin-top:6px;">
                                <div class="strength-segment" id="seg1"
                                    style="flex:1;height:3px;border-radius:99px;background:var(--border);transition:background 0.3s;">
                                </div>
                                <div class="strength-segment" id="seg2"
                                    style="flex:1;height:3px;border-radius:99px;background:var(--border);transition:background 0.3s;">
                                </div>
                                <div class="strength-segment" id="seg3"
                                    style="flex:1;height:3px;border-radius:99px;background:var(--border);transition:background 0.3s;">
                                </div>
                                <div class="strength-segment" id="seg4"
                                    style="flex:1;height:3px;border-radius:99px;background:var(--border);transition:background 0.3s;">
                                </div>
                            </div>
                            <div id="strengthLabel"
                                style="font-size:0.72rem;margin-top:3px;color:var(--text-secondary);"></div>
                            @error('password')
                                <div class="error-msg">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <button type="button" class="toggle-password"
                                    onclick="togglePassword('password_confirmation','eyeOpen-confirmation','eyeClosed-confirmation')"
                                    aria-label="Toggle konfirmasi password">
                                    <svg id="eyeOpen-confirmation" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <svg id="eyeClosed-confirmation" xmlns="http://www.w3.org/2000/svg"
