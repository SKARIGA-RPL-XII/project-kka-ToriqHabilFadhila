        ...
        <div class="flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <div class="flex justify-center">
                    <a href="{{ route('google.auth', ['mode' => 'register']) }}" onclick="handleGoogleLogin(this)" class="flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-xl transition-all duration-200 w-full">
